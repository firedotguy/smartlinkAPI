...
def api_get_box(id: int):
    ...
    if house:
        ...
        customers_id = api_call('customer', 'get_customers_id', f'house_id={house["building_id"]}')['data']
        customers = [{
            'id': customer['id'],
        ...
        } for customer in normalize_items(api_call('customer', 'get_data', f'id={list_to_str(customers_id)}'))]
