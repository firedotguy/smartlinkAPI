...
class BuildingType(Enum):
    multiflat = 1  # многоквартирные дома
    private = 2  # частный сектор
    office = 3  # офисное здание
    osh_private = 4  # ОШ частные дома
    osh_multiflat = 5  # ОШ многоквартирные дома
    ravshan = 6  # Ош сеть А.Равшана
    djalal_multiflat = 7  # Джалал-А многоквартирные дома
    new = 8  # Новостройки
...
class ItemType(Enum):
    ...
    junction = "3bdffaa5-3e68-453f-9bbd-8de2a76701da"  # расрпед коробка
