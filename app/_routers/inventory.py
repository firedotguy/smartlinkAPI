...
from app._utils import normalize_items, list_to_str

router = APIRouter(prefix="/inventory")


@router.get("")
def api_get_inventory(customer_id: int | None = None, get_names: bool = True):
    items = []
    ...
    return {"status": "success", "data": named_items or items}
